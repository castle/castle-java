...
public class ContextMerge {
    /**
     * Merge the target and the source json tree.
     * The target value is not mutated during the process. References to the source tree elements may be used on the resulting tree.
     * @param target
     * @param source
     * @return
     */
    public JsonObject merge(JsonObject target, JsonObject source) {
