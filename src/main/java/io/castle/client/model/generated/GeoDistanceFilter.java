...
public class GeoDistanceFilter implements OneOfGeoQueryFilterValue {
  @SerializedName("distance")
  private BigDecimal distance = null;

  /**
   * Units to filter geolocation by
   */
  ...
  public GeoDistanceFilter distance(BigDecimal distance) {
    this.distance = distance;
    return this;
  }

   /**
   * Distance in radius from center point
   * minimum: 0
   * @return distance
  **/
  @ApiModelProperty(required = true, value = "Distance in radius from center point")
  ...
  public GeoDistanceFilter units(UnitsEnum units) {
    this.units = units;
    return this;
  }
   ...
   * @return units
  **/
  @ApiModelProperty(required = true, value = "Units to filter geolocation by")
  ...
  public GeoDistanceFilter coordinates(Coordinates coordinates) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.distance, geoDistanceFilter.distance) &&
        Objects.equals(this.units, geoDistanceFilter.units) &&
        Objects.equals(this.coordinates, geoDistanceFilter.coordinates);
  }

  @Override
  public int hashCode() {
    return Objects.hash(distance, units, coordinates);
  }
