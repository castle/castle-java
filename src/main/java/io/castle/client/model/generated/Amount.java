...
public class Amount {
  ...
  @ApiModelProperty(example = "1.512342352", value = "Monetary amount of transaction with decimals")
  ...
  /**
   * Currency code, required when value is provided
   * @return currency
   **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "BTC", value = "Currency code, required when value is provided")
