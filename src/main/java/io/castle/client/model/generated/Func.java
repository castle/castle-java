...
/**
 * Aggregation function to be applied on the field
 */
@JsonAdapter(Func.Adapter.class)
public enum Func {
  @SerializedName("$sum")
  SUM("$sum"),
  @SerializedName("$last")
  ...
  public static Func fromValue(String input) {
    for (Func b : Func.values()) {
  ...
  public static class Adapter extends TypeAdapter<Func> {
    @Override
    public void write(final JsonWriter jsonWriter, final Func enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public Func read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return Func.fromValue((String)(value));
    }
  }
}
