 ...
 */
@JsonAdapter(Transforms.Adapter.class)
public enum Transforms {
  @SerializedName("$to_start_of_interval")
  _TO_START_OF_INTERVAL("$to_start_of_interval");
  ...
  public static Transforms fromValue(String input) {
    for (Transforms b : Transforms.values()) {
  ...
  public static class Adapter extends TypeAdapter<Transforms> {
    @Override
    public void write(final JsonWriter jsonWriter, final Transforms enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public Transforms read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return Transforms.fromValue((String)(value));
    }
  }
}
