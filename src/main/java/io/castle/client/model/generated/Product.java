...
public class Product {
  ...
  public Product id(String id) {
   ...
   /**
   * If you have multiple products that your users can log into using the same credentials, populate this field so that you can segment the data in the dashboard by product.
   * @return id
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "If you have multiple products that your users can log into using the same credentials, populate this field so that you can segment the data in the dashboard by product.")
