...
public class CountBucket extends BaseBucket implements AnyOfSearchSchemaBucketsItems {
  ...
  private CountBucketOptions options = null;

  public CountBucket type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @ApiModelProperty(example = "$count", required = true, value = "")
  ...
  public CountBucket options(CountBucketOptions options) {
  ...
  **/
  ...
  public CountBucketOptions getOptions() {
    return options;
  }

  public void setOptions(CountBucketOptions options) {
    this.options = options;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, countBucket.type) &&
        Objects.equals(this.options, countBucket.options) &&
        super.equals(o);
  }
