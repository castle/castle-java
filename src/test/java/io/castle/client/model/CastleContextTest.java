...
public class CastleContextTest {
    ...
    public void toStringMethodCreatesAWellFormedStringFromAnEmptyContextInstance() {
        ...
        // given
        String expected = "CastleContext{active=true, device=null, clientId='null', ip='null', locale='null', timezone='null', page=null, referrer=null, headers=null, library=CastleSdkRef{name='Castle', version='0.6.0-SNAPSHOT'}, location=null, network=null, os=null, screen=null, userAgent='null'}";
        CastleContext context = new CastleContext();
    ...
    public void toStringMethodCreatesAWellFormedStringFromAFullExample() {
        ...
        String expected = "CastleContext{active=false, " +
                ...
                "library=CastleSdkRef{name='Castle', version='0.6.0-SNAPSHOT'}, " +
