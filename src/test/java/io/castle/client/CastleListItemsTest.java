...
public class CastleListItemsTest extends AbstractCastleHttpLayerTest {
    ...
    public void searchListItems() throws InterruptedException {
        ...
        filters.add(new ListItemQueryFilter().field(ListItemQueryFilter.FieldEnum.PRIMARY_VALUE).op(Op.EQ).value("Uc80JFKRRvm"));
        filters.add(new ListItemQueryFilter().field(ListItemQueryFilter.FieldEnum.ARCHIVED).op(Op.EQ).value(false));
        filters.add(new ListItemOrQueryFilter().op(Op.EQ).value(List.of(new ListItemQueryFilter().field(ListItemQueryFilter.FieldEnum.SECONDARY_VALUE).op(Op.EQ).value("1"))));
    ...
    public void countListItems() throws InterruptedException {
        ...
        filters.add(new ListItemQueryFilter().field(ListItemQueryFilter.FieldEnum.ARCHIVED).op(Op.EQ).value(false));
        filters.add(new ListItemOrQueryFilter().op(Op.EQ).value(List.of(new ListItemQueryFilter().field(ListItemQueryFilter.FieldEnum.SECONDARY_VALUE).op(Op.EQ).value("1"))));
        filters.add(new ListItemOrQueryFilter().op(Op.EQ).value(List.of(new ListItemQueryFilter().field(ListItemQueryFilter.FieldEnum.SECONDARY_VALUE).op(Op.EQ).value("2"))));
        listItemQuery.filters(filters);
